/**
 * @file TM4C129ENCPDT_systick_wfi_main.c
 * @date 05/12/20
 ...
 *
 *          The target board is a EK-TM4C129EXL
 */
#include <stdint.h>
#include <stdbool.h>
...
/** TM4C129ENCPDT datasheet gives maximum wake-up time from sleep as 39 microseconds for
