...
/* Table which defines how the 3840MB heap is tested. It uses a number of different allocations, for which the total size of
 * the allocations made adds up to 3840MB. */
#define MAX_ALLOCS 4
static const struct
{
    uint32_t num_allocs;
...
{
    {.num_allocs = 1, .alloc_sizes = {0xF0000000}},
    {.num_allocs = 2, .alloc_sizes = {0xC0000000, 0x30000000}},
    {.num_allocs = 3, .alloc_sizes = {0x80000000, 0x60000000, 0x10000000}},
    {.num_allocs = 4, .alloc_sizes = {0x80000000, 0x30000000, 0x30000000, 0x10000000}}
};
 ...
 */
/**
 * @brief Task which tests the 3840MB heap, to determine the total size of allocations which can be made.
