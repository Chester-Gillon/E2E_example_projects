...
// PSF edit:  added a wrapper so the function always runs in privileged mode
#pragma SWI_ALIAS(psfRaisePrivilege, 1);
extern BaseType_t psfRaisePrivilege( void );
BaseType_t old_xTaskResumeAll( void );
BaseType_t xTaskResumeAll (void)
{
	BaseType_t xReturn;
	BaseType_t xRunningPrivileged = psfRaisePrivilege();

	xReturn = old_xTaskResumeAll();
